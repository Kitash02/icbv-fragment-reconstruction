...
def hard_reject_check(
    ...
    # VARIANT 5 ITERATION 3: Relaxed from 0.70/0.65 to 0.65/0.60
    # The color^6 penalty handles discrimination; hard disc just filters extreme outliers
    ...
    # VARIANT 5: Keep this check - it's important for negative accuracy
