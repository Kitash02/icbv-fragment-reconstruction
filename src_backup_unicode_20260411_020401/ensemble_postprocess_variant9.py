...
- Uses BASELINE formula (color^4 × texture^2 × gabor^2 × haralick^2)
...
def reclassify_borderline_cases(
    ...
    - Baseline formula powers (color^4 × texture^2 × gabor^2 × haralick^2)
    ...
    logger.info("Formula: BASELINE (color^4 × texture^2 × gabor^2 × haralick^2)")
