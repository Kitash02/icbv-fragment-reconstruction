...
------------------------------
This variant lowers all thresholds to recover false negatives:
  - MATCH_SCORE_THRESHOLD:        0.70 (baseline: 0.75)
  - WEAK_MATCH_SCORE_THRESHOLD:   0.55 (baseline: 0.60)
  - ASSEMBLY_CONFIDENCE_THRESHOLD: 0.60 (baseline: 0.65)

Description: "Lower thresholds to recover false negatives"
"""
...
# VARIANT 4: RELAXED THRESHOLDS - Lower thresholds to recover false negatives
MATCH_SCORE_THRESHOLD = 0.70        # pair is a confident match (baseline: 0.75)
WEAK_MATCH_SCORE_THRESHOLD = 0.55   # pair is a possible but uncertain match (baseline: 0.60)
ASSEMBLY_CONFIDENCE_THRESHOLD = 0.60  # assembly overall is accepted as a match (baseline: 0.65)
