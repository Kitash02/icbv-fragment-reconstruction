"""
Hard Discriminator Module - Variant 0 Iteration 3
EVOLUTIONARY OPTIMIZATION: Aggressive tightening

Iteration 3 Strategy:
- Aggressive tightening to achieve 95%+ negative accuracy
- 0.74→0.76 color (+2.7%), 0.69→0.71 texture (+2.9%)
- This approaches variant 0B's 0.75/0.70 thresholds
- May sacrifice some positive accuracy but prioritize precision

Target: 95%+ negative accuracy, ideally 75%+ positive

Changes from iteration 2:
- Line 137: bc_color < 0.74 → bc_color < 0.76
- Line 137: bc_texture < 0.69 → bc_texture < 0.71
"""
...
def hard_reject_check(
    ...
    # ITERATION 3: Raised from 0.74/0.69 to 0.76/0.71
